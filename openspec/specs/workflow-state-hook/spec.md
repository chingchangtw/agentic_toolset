# workflow-state-hook Specification

## Purpose

TBD - created by archiving change 'inject-workflow-state-hook'. Update Purpose after archive.
...
<!-- @trace
source: inject-workflow-state-hook
updated: 2026-06-30
code:
  ...
  - tasks/wfImprovementToDo.md
  - release/install.sh
  - .ai/ts-deliver-router/state.json
  - .ai/discovery.json
tests:
  - src/tests/fixtures/phases/ship.json
  - src/tests/fixtures/phases/think.json
  - src/tests/fixtures/phases/test.json
  - src/tests/fixtures/phases/review.json
  - src/tests/fixtures/phases/reflect.json
  - src/tests/unit/hook-output.test.ts
  - src/tests/fixtures/iteration-active.json
  - src/tests/fixtures/phases/build.json
  - src/tests/fixtures/phases/plan.json
-->
